...
--------------------------------------------------------------------
Insert into PROSESS_TASK_FEILHAND (KODE,NAVN,BESKRIVELSE,OPPRETTET_AV,OPPRETTET_TID,ENDRET_AV,ENDRET_TID,INPUT_VARIABEL1,INPUT_VARIABEL2) values ('DEFAULT','Eksponentiell back-off med tak',null,'VL',systimestamp,null,null,null,null);

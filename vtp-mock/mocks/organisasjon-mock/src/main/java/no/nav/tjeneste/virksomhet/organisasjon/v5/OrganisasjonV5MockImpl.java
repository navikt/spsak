...
import no.nav.tjeneste.virksomhet.organisasjon.v5.binding.FinnOrganisasjonForMangeForekomster;
import no.nav.tjeneste.virksomhet.organisasjon.v5.binding.FinnOrganisasjonUgyldigInput;
import no.nav.tjeneste.virksomhet.organisasjon.v5.binding.FinnOrganisasjonsendringerListeUgyldigInput;
...
import no.nav.tjeneste.virksomhet.organisasjon.v5.binding.ValiderOrganisasjonOrganisasjonIkkeFunnet;
import no.nav.tjeneste.virksomhet.organisasjon.v5.binding.ValiderOrganisasjonUgyldigInput;
...
public class OrganisasjonV5MockImpl implements OrganisasjonV5 {
    ...
    @Override
    @WebMethod(action = "http://nav.no/tjeneste/virksomhet/organisasjon/v5/BindingfinnOrganisasjon/")
    ...
    @Override
    @WebMethod(action = "http://nav.no/tjeneste/virksomhet/organisasjon/v5/Bindingping/")
    ...
    @Override
    @WebMethod(action = "http://nav.no/tjeneste/virksomhet/organisasjon/v5/BindinghentOrganisasjonsnavnBolk/")
    @WebResult(name = "response", targetNamespace = "")
    ...
    @Override
    @WebMethod(action = "http://nav.no/tjeneste/virksomhet/organisasjon/v5/BindinghentNoekkelinfoOrganisasjon/")
    @WebResult(name = "response", targetNamespace = "")
    ...
    @Override
    @WebMethod(action = "http://nav.no/tjeneste/virksomhet/organisasjon/v5/BindingvaliderOrganisasjon/")
    @WebResult(name = "response", targetNamespace = "")
    ...
    @Override
    @WebMethod(action = "http://nav.no/tjeneste/virksomhet/organisasjon/v5/BindinghentVirksomhetsOrgnrForJuridiskOrgnrBolk/")
    @WebResult(name = "response", targetNamespace = "")
    ...
    @Override
    @WebMethod(action = "http://nav.no/tjeneste/virksomhet/organisasjon/v5/BindingfinnOrganisasjonsendringerListe/")
    @WebResult(name = "response", targetNamespace = "")

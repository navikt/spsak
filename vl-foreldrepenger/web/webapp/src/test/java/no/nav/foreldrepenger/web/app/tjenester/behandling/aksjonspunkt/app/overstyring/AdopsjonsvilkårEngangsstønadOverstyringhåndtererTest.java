...
public class AdopsjonsvilkårEngangsstønadOverstyringhåndtererTest {
    ...
    public void skal_opprette_aksjonspunkt_for_overstyring() {
        ...
        // Act
        AdopsjonsvilkåretOverstyringshåndterer overstyringshåndterer = new AdopsjonsvilkåretOverstyringshåndterer(repositoryProvider, historikkAdapter, inngangsvilkårTjeneste);

...
public class BeregningsgrunnlagPrStatusOgAndelDtoTest {
    ...
    private VirksomhetTjeneste virksomhetTjeneste = mock(VirksomhetTjenesteImpl.class);
    ...
    public void setup() {
        ...
        beregningsgrunnlagDtoUtil = new BeregningsgrunnlagDtoUtil(repositoryProvider, tpsTjenesteMock);
    ...
    private no.nav.foreldrepenger.behandlingslager.behandling.beregningsgrunnlag.BeregningsgrunnlagPeriode buildBeregningsgrunnlagPeriode(Beregningsgrunnlag beregningsgrunnlag) {

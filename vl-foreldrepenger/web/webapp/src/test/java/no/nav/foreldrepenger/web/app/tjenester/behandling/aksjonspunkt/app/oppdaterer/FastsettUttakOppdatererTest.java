...
public class FastsettUttakOppdatererTest {
    ...
    public void skalReturnereUtenOveropp() {
        ...
        FastsettUttakOppdaterer oppdaterer = new FastsettUttakOppdaterer(repositoryProvider, historikkAdapterTjeneste(), tjeneste, aksjonspunktRepository());
        ...
        OppdateringResultat result = oppdaterer.oppdater(dto, behandling);

...
public class OpprettSakTjenesteImpl implements OpprettSakTjeneste {
    ...
    @Override
    public Fagsak opprettSakVL(AktørId aktørId, BehandlingTema behandlingTema) {
        ...
        Fagsak fagsak = Fagsak.opprettNy(utledYtelseType(aktørId, behandlingTema), bruker);
    ...
    @Override
    public Fagsak opprettSakVL(AktørId aktørId, BehandlingTema behandlingTema, JournalpostId journalpostId) {
        Optional<Personinfo> personinfoOptional = tpsTjeneste.hentBrukerForAktør(aktørId);
    ...
    private FagsakYtelseType utledYtelseType(AktørId aktorId, BehandlingTema behandlingTema) {

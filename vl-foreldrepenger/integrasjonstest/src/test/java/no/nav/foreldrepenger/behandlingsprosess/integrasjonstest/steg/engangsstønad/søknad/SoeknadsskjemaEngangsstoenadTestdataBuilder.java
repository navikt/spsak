...
public class SoeknadsskjemaEngangsstoenadTestdataBuilder {
    ...
    public SoeknadsskjemaEngangsstoenadTestdataBuilder medAktoerId(String aktoerId) {
        AktoerId aktoer = new AktoerId();
        aktoer.setAktoerId(aktoerId);
        soeknadsskjemaEngangsstoenad.setBruker(aktoer);
        return this;
    }
    ...
    public SoeknadsskjemaEngangsstoenadTestdataBuilder medBegrunnelse(String begrunnelse) {
        OpplysningerOmBarn opplysningerOmBarn = getOpplysningerOmBarn();
        opplysningerOmBarn.setBegrunnelse(begrunnelse);
        soeknadsskjemaEngangsstoenad.setOpplysningerOmBarn(opplysningerOmBarn);
        return this;
    }

...
import no.nav.foreldrepenger.skjæringstidspunkt.regel.RegelFastsettSkjæringstidspunkt;
import no.nav.foreldrepenger.skjæringstidspunkt.regelmodell.AktivitetStatusModell;
import no.nav.foreldrepenger.skjæringstidspunkt.status.RegelFastsettStatusVedSkjæringstidspunkt;

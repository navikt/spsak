...
public class FullføreBeregningsgrunnlag {
    ...
    public Beregningsgrunnlag fullføreBeregningsgrunnlag(Behandling behandling, Beregningsgrunnlag beregningsgrunnlag) {
        ...
        no.nav.foreldrepenger.beregningsgrunnlag.regelmodell.resultat.Beregningsgrunnlag beregningsgrunnlagRegel = oversetterTilRegel.map(behandling, beregningsgrunnlag);
    ...
    private String toJson(no.nav.foreldrepenger.beregningsgrunnlag.regelmodell.resultat.Beregningsgrunnlag beregningsgrunnlagRegel) {

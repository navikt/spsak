...
public class RegelMapperTestDataHelper {
    ...
    public static BeregningsgrunnlagPrStatus buildRegelBGPeriode(no.nav.foreldrepenger.beregningsgrunnlag.regelmodell.resultat.BeregningsgrunnlagPeriode regelBGP, no.nav.foreldrepenger.beregningsgrunnlag.regelmodell.AktivitetStatus status, Periode periode) {
        if (no.nav.foreldrepenger.beregningsgrunnlag.regelmodell.AktivitetStatus.erArbeidstakerEllerFrilanser(status)) {
    ...
    public static no.nav.foreldrepenger.beregningsgrunnlag.regelmodell.resultat.Beregningsgrunnlag buildRegelBeregningsgrunnlag(no.nav.foreldrepenger.beregningsgrunnlag.regelmodell.AktivitetStatus aktivitetStatus,
                                                                                                                                no.nav.foreldrepenger.beregningsgrunnlag.regelmodell.grunnlag.inntekt.Inntektskategori inntektskategori,
                                                                                                                                BeregningsgrunnlagHjemmel hjemmel) {
        no.nav.foreldrepenger.beregningsgrunnlag.regelmodell.resultat.BeregningsgrunnlagPeriode periode = buildRegelBGPeriode(aktivitetStatus, inntektskategori);
        return no.nav.foreldrepenger.beregningsgrunnlag.regelmodell.resultat.Beregningsgrunnlag.builder()
    ...
    private static no.nav.foreldrepenger.beregningsgrunnlag.regelmodell.resultat.BeregningsgrunnlagPeriode buildRegelBGPeriode(no.nav.foreldrepenger.beregningsgrunnlag.regelmodell.AktivitetStatus aktivitetStatus, no.nav.foreldrepenger.beregningsgrunnlag.regelmodell.grunnlag.inntekt.Inntektskategori inntektskategori) {
        no.nav.foreldrepenger.beregningsgrunnlag.regelmodell.resultat.BeregningsgrunnlagPeriode.Builder periodeBuilder =
            no.nav.foreldrepenger.beregningsgrunnlag.regelmodell.resultat.BeregningsgrunnlagPeriode.builder()
                .medPeriode(Periode.of(NOW, null));
        long andelNr = 1;
        if (no.nav.foreldrepenger.beregningsgrunnlag.regelmodell.AktivitetStatus.erKombinasjonMedSelvstendig(aktivitetStatus)) {
            BeregningsgrunnlagPrStatus prStatusATFL = buildPrStatus(no.nav.foreldrepenger.beregningsgrunnlag.regelmodell.AktivitetStatus.ATFL, inntektskategori, null);
            BeregningsgrunnlagPrStatus prStatusSN = buildPrStatus(no.nav.foreldrepenger.beregningsgrunnlag.regelmodell.AktivitetStatus.SN, no.nav.foreldrepenger.beregningsgrunnlag.regelmodell.grunnlag.inntekt.Inntektskategori.SELVSTENDIG_NÆRINGSDRIVENDE, andelNr);
    ...
    private static BeregningsgrunnlagPrStatus buildPrStatus(no.nav.foreldrepenger.beregningsgrunnlag.regelmodell.AktivitetStatus aktivitetStatus, no.nav.foreldrepenger.beregningsgrunnlag.regelmodell.grunnlag.inntekt.Inntektskategori inntektskategori, Long andelNr) {
        return BeregningsgrunnlagPrStatus.builder()
            .medAktivitetStatus(aktivitetStatus)
            .medInntektskategori(inntektskategori)
            .medAndelNr(no.nav.foreldrepenger.beregningsgrunnlag.regelmodell.AktivitetStatus.erArbeidstaker(aktivitetStatus) ? null : andelNr)
            .build();
    }
}

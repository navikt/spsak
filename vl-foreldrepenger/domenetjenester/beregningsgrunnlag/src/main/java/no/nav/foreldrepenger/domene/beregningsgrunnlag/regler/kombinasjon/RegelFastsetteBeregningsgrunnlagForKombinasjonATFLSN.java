...
import no.nav.foreldrepenger.domene.beregningsgrunnlag.regler.arbeidstaker.SjekkOmFørsteBeregningsgrunnlagsperiode;
import no.nav.foreldrepenger.domene.beregningsgrunnlag.regler.selvstendig.BeregnGjennomsnittligPGI;
import no.nav.foreldrepenger.domene.beregningsgrunnlag.regler.selvstendig.BeregnOppjustertInntekt;
import no.nav.foreldrepenger.domene.beregningsgrunnlag.regler.selvstendig.FastsettBeregningsperiode;
import no.nav.foreldrepenger.domene.beregningsgrunnlag.regler.selvstendig.FastsettSammenligningsgrunnlagForSN;
import no.nav.foreldrepenger.domene.beregningsgrunnlag.regler.selvstendig.SjekkOmBrukerErNyIArbeidslivet;
import no.nav.foreldrepenger.domene.beregningsgrunnlag.regler.selvstendig.SjekkOmDifferanseStørreEnn25Prosent;
import no.nav.foreldrepenger.domene.beregningsgrunnlag.regler.selvstendig.SjekkOmManueltFastsattBeregningsgrunnlagSN;
import no.nav.foreldrepenger.domene.beregningsgrunnlag.regler.selvstendig.SjekkOmVarigEndringIVirksomhetEllerNyoppstartetNæring;

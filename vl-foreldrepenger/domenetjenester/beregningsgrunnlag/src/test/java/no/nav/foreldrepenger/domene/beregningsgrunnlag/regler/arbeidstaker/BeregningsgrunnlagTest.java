...
import static no.nav.foreldrepenger.domene.beregningsgrunnlag.regler.BeregningsgrunnlagScenario.kopierOgLeggTilMånedsinntekter;
import static no.nav.foreldrepenger.domene.beregningsgrunnlag.regler.BeregningsgrunnlagScenario.leggTilArbeidsforholdMedInntektsmelding;
import static no.nav.foreldrepenger.domene.beregningsgrunnlag.regler.BeregningsgrunnlagScenario.leggTilArbeidsforholdUtenInntektsmelding;
...
import no.nav.foreldrepenger.domene.beregningsgrunnlag.regler.arbeidstaker.BeregnRapportertInntektVedManuellFastsettelse;

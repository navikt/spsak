...
public class RegelOpprettBeregningsgrunnlagsandelerForTilstøtendeYtelseDocTest {
    ...
    public void test_documentation_beregningsgrunnlagSN() throws Exception {
        Specification<BeregningsgrunnlagFraTilstøtendeYtelse> regel = new RegelOpprettBeregningsgrunnlagsandelerForTilstøtendeYtelse().getSpecification();
        RuleDescriptionDigraph digraph = new RuleDescriptionDigraph(regel.ruleDescription());

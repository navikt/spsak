...
import static no.nav.foreldrepenger.domene.uttak.perioder.PerioderUtenHelgUtil.likNårHelgIgnoreres;
import static no.nav.foreldrepenger.domene.uttak.perioder.PerioderUtenHelgUtil.periodeUtenHelgOmslutter;
import static no.nav.foreldrepenger.domene.uttak.perioder.PerioderUtenHelgUtil.perioderUtenHelgOverlapper;
...
public class PerioderUtenHelgUtilTest {
    ...
    @Test
    public void skal_si_at_perioder_med_tom_er_lik_andre_fom_overlapper() {
        assertThat(perioderUtenHelgOverlapper(new LukketPeriode(fredagUke1, mandagUke2), new LukketPeriode(mandagUke2, søndagUke2))).isTrue();
    }

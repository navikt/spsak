...
public class PeriodeSplitterMotVenstreTest {
    ...
    public void justert_periode_er_etter_ikke_flyttbar_periode() {
        OppgittPeriode utsettelsePgaFerie = builder().medÅrsak(UtsettelseÅrsak.FERIE).medPeriode(LocalDate.of(2018, 6, 11), LocalDate.of(2018, 6, 17)).build();
        OppgittPeriode uttakPeriode = builder().medPeriode(LocalDate.of(2018, 6, 25), LocalDate.of(2018, 7, 1)).build();

        List<OppgittPeriode> splittedePerioder = PeriodeSplitter.splittPeriodeMotVenstre(Arrays.asList(utsettelsePgaFerie), uttakPeriode, -7);
    ...
    public void justert_periode_kommer_før_ikke_flyttbar_periode() {
        ...
        List<OppgittPeriode> splittedePerioder = PeriodeSplitter.splittPeriodeMotVenstre(Arrays.asList(utsettelsePgaFerie), uttakPeriode, -14);
    ...
    public void justert_periode_overlapper_på_slutten_av_ikke_flyttbar_periode() {
        ...
        List<OppgittPeriode> splittedePerioder = PeriodeSplitter.splittPeriodeMotVenstre(Arrays.asList(utsettelsePgaFerie), uttakPeriode, -9);
    ...
    public void justert_periode_flyttes_mellom_to_ikke_flyttbar_perioder() {
        ...
        List<OppgittPeriode> splittedePerioder = PeriodeSplitter.splittPeriodeMotVenstre(Arrays.asList(utsettelsePgaFerie1, utsettelsePgaFerie2), uttakPeriode, -7);
    ...
    public void justert_periode_flyttes_før_to_ikke_flyttbar_perioder() {
        ...
        List<OppgittPeriode> splittedePerioder = PeriodeSplitter.splittPeriodeMotVenstre(Arrays.asList(utsettelsePgaFerie1, utsettelsePgaFerie2), uttakPeriode, -14);

...
public interface BehandlendeEnhetTjeneste {
    ...
    Optional<OrganisasjonsEnhet> endretBehandlendeEnhetFraOppgittAnnenPart(Behandling behandling);
    ...
    Optional<OrganisasjonsEnhet> endretBehandlendeEnhetEtterFagsakKobling(Behandling behandling, FagsakRelasjon kobling);

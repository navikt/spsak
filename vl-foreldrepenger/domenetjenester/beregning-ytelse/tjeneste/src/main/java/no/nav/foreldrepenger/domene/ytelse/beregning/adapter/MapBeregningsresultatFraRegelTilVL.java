...
import no.nav.foreldrepenger.beregningsgrunnlag.adapter.util.BeregningsgrunnlagUtil;
...
public class MapBeregningsresultatFraRegelTilVL {
    ...
    private static BeregningsresultatAndel mapFraAndel(no.nav.foreldrepenger.beregning.regelmodell.BeregningsresultatAndel bra, no.nav.foreldrepenger.behandlingslager.behandling.beregning.BeregningsresultatPeriode brp, VirksomhetRepository virksomhetRepository) {

...
public class DokumentData extends BaseEntitet implements IndexKey {
    ...
    public DokumentData(DokumentMalType dokumentMalType, Behandling behandling) {
    ...
    public static DokumentData opprettNy(DokumentMalType dokumentMalType, Behandling behandling) {
    ...
    public static class Builder {
        ...
        public DokumentData.Builder medBehandling(Behandling behandling) {
            this.behandling = behandling;
            return this;
        }

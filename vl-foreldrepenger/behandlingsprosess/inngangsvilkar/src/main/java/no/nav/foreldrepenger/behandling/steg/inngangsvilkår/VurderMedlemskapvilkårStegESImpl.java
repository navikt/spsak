...
@ApplicationScoped
public class VurderMedlemskapvilkårStegESImpl extends InngangsvilkårStegImpl {
    ...
    @Inject
    public VurderMedlemskapvilkårStegESImpl(BehandlingRepositoryProvider repositoryProvider, RegelOrkestrerer regelOrkestrerer) {

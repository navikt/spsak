INSERT INTO KODELISTE (id, kodeverk, kode, offisiell_kode, navn, beskrivelse, gyldig_fom)
    VALUES (SEQ_KODELISTE.nextval, 'RELATERT_YTELSE_BEH_TEMA', 'ARAN', 'Andre behandlingstema Arena', 'Andre behandlingstema Arena', 'Andre behandlingstema Arena', to_date('2000-01-01', 'YYYY-MM-DD'));

...
public class InnhentingSamletTjenesteImplTest {
    ...
    public void before() throws FinnSakListeUgyldigInput, FinnSakListePersonIkkeFunnet, FinnSakListeSikkerhetsbegrensning {
        ...
        infotrygdBeregningsgrunnlagTjeneste = new InfotrygdBeregningsgrunnlagTjeneste(infotrygdBeregningsgrunnlagConsumer,kodeverkRepository);
        infotrygdTjeneste = new InfotrygdTjeneste(infotrygdSakConsumer, kodeverkRepository);
        meldekortTjeneste = new MeldekortTjeneste(meldekortUtbetalingsgrunnlagConsumer);
        innhentingSamletTjeneste = new InnhentingSamletTjeneste(null,tpsTjeneste,null,

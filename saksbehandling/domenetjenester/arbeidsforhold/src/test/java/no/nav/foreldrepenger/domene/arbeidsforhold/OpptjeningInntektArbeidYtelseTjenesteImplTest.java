...
import static no.nav.foreldrepenger.domene.arbeidsforhold.YtelseTestUtils.leggTilYtelse;
import static no.nav.foreldrepenger.domene.arbeidsforhold.YtelseTestUtils.opprettInntektArbeidYtelseAggregatForYrkesaktivitet;
...
public class OpptjeningInntektArbeidYtelseTjenesteImplTest {
    ...
    private InntektArbeidYtelseTjeneste tjeneste = new InntektArbeidYtelseTjeneste(repositoryProvider, null, null, null, skjæringstidspunktTjeneste, aksjonspunktutlederForVurderOpptjening);
    private OpptjeningsperioderTjeneste asdf = new OpptjeningsperioderTjeneste(tjeneste, repositoryProvider, resultatRepositoryProvider, aksjonspunktutlederForVurderOpptjening);
    private OpptjeningInntektArbeidYtelseTjeneste opptjeningTjeneste = new OpptjeningInntektArbeidYtelseTjeneste(tjeneste, resultatRepositoryProvider, asdf);

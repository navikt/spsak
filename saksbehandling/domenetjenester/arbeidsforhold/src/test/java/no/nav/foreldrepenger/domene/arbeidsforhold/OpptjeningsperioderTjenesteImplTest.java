...
public class OpptjeningsperioderTjenesteImplTest {
    ...
    private InntektArbeidYtelseTjeneste tjeneste = new InntektArbeidYtelseTjeneste(repositoryProvider, null, null, null,
        skjæringstidspunktTjeneste, aksjonspunktutlederForVurderOpptjening);
    private OpptjeningsperioderTjeneste forSaksbehandlingTjeneste = new OpptjeningsperioderTjeneste(tjeneste, repositoryProvider, resultatRepositoryProvider, aksjonspunktutlederForVurderOpptjening);

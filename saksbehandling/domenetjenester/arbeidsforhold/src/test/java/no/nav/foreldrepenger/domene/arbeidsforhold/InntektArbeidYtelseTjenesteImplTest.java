...
public class InntektArbeidYtelseTjenesteImplTest {
    ...
    public void setUp() throws Exception {
        ...
        tjeneste = new InntektArbeidYtelseTjeneste(repositoryProvider, arbeidsforholTjenesteMock.getMock(), tpsTjeneste, virksomhetTjeneste, skjæringstidspunktTjeneste, aksjonspunktutlederForVurderOpptjening);
        arbeidsforholdTjeneste = new ArbeidsforholdAdministrasjonTjeneste(repositoryProvider, vurderArbeidsforholdTjeneste, tpsTjeneste, skjæringstidspunktTjeneste);
    }

...
import no.nav.foreldrepenger.behandlingslager.behandling.inntektarbeidytelse.*;
import no.nav.foreldrepenger.behandlingslager.behandling.inntektarbeidytelse.grunnlag.YtelseGrunnlag;
import no.nav.foreldrepenger.behandlingslager.behandling.inntektarbeidytelse.kodeverk.*;
...
import no.nav.foreldrepenger.domene.arbeidsforhold.arbeid.*;
...
public class IAYRegisterInnhentingTjeneste {
    ...
    private no.nav.foreldrepenger.behandlingslager.behandling.inntektarbeidytelse.grunnlag.Permisjon opprettPermisjoner(Permisjon permisjon,

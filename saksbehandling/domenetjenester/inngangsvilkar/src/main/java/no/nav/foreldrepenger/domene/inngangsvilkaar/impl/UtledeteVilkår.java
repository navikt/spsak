...
public class UtledeteVilkår {
     ...
     static no.nav.foreldrepenger.domene.inngangsvilkaar.impl.UtledeteVilkår forAvklartRelasjonsvilkårTilBarn(VilkårType betingetVilkårType, List<VilkårType> tilhørendeVilkårTyper) {
         no.nav.foreldrepenger.domene.inngangsvilkaar.impl.UtledeteVilkår utledeteVilkår = new no.nav.foreldrepenger.domene.inngangsvilkaar.impl.UtledeteVilkår();
     ...
     static no.nav.foreldrepenger.domene.inngangsvilkaar.impl.UtledeteVilkår forAvklartRelasjonsvilkårTilBarn(List<VilkårType> tilhørendeVilkårTyper) {
         no.nav.foreldrepenger.domene.inngangsvilkaar.impl.UtledeteVilkår utledeteVilkår = new no.nav.foreldrepenger.domene.inngangsvilkaar.impl.UtledeteVilkår();

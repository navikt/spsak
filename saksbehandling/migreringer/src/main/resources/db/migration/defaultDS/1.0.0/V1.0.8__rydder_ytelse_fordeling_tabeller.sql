drop table ETTERKONTROLL_LOGG cascade ;
drop table YF_FORDELING_PERIODE cascade ;
drop table YF_DOKUMENTASJON_PERIODE cascade;
drop table YF_AVKLART_DATO cascade ;
drop table YF_DOKUMENTASJON_PERIODER cascade ;
drop table YF_FORDELING cascade ;
drop table GR_YTELSES_FORDELING cascade ;
drop table STOENADSKONTO cascade ;
drop table STOENADSKONTOBEREGNING cascade ;
drop table SO_DEKNINGSGRAD cascade ;
drop table SO_RETTIGHET cascade ;
drop table UTGAAENDE_HENDELSE cascade ;
drop table IAY_UTSETTELSE_PERIODE cascade ;

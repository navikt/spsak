...
DELETE FROM KODELISTE_NAVN_I18N WHERE KL_KODEVERK = 'DOKUMENT_GRUPPE';
DELETE FROM KODELISTE WHERE KODEVERK = 'DOKUMENT_GRUPPE';
DELETE FROM KODEVERK WHERE KODE  = 'DOKUMENT_GRUPPE';

DELETE FROM KODELISTE_NAVN_I18N WHERE KL_KODEVERK = 'LAGRET_VEDTAK_TYPE';
DELETE FROM KODELISTE WHERE KODEVERK = 'LAGRET_VEDTAK_TYPE';
DELETE FROM KODEVERK WHERE KODE  = 'LAGRET_VEDTAK_TYPE';

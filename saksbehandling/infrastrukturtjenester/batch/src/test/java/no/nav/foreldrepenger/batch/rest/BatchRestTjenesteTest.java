...
import no.nav.foreldrepenger.batch.rest.BatchArgumentsDto;
import no.nav.foreldrepenger.batch.rest.BatchNameDto;
...
public class BatchRestTjenesteTest {
    ...
    public void skal_gi_exception_ved_ugyldig_job_parametere() {
        final Map<String, BatchTjeneste> stringBatchTjenesteHashMap = new HashMap<>();

...
import no.nav.foreldrepenger.web.app.tjenester.behandling.beregningsgrunnlag.aksjonspunkt.dto.VurderATogFLiSammeOrganisasjonAndelDto;
import no.nav.foreldrepenger.web.app.tjenester.behandling.beregningsgrunnlag.aksjonspunkt.dto.VurderATogFLiSammeOrganisasjonDto;
...
public class FastsettMånedsinntektATogFLiSammeOrganisasjonOppdaterer {
    ...
    @Inject
    public FastsettMånedsinntektATogFLiSammeOrganisasjonOppdaterer(GrunnlagRepositoryProvider repositoryProvider,

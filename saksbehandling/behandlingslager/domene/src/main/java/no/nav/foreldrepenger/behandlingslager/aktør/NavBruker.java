...
public class NavBruker extends Person {
    ...
    public static NavBruker opprettNy(AktørId aktørId) {
        return opprettNy(aktørId, Språkkode.nb);
    }
    
    public static NavBruker opprettNy(AktørId aktørId, Språkkode språkkode) {

...
public class JournalTjenesteUtilTest {
    ...
    @Test
    public void skal_konvertere_metadata() throws DatatypeConfigurationException {
    ...
    private InngaaendeJournalpost lagInngåendeJournalPost() throws DatatypeConfigurationException {

...
public class HentOgVurderInfotrygdSakTaskTest {
    ...
    private Period startdatoDiff = Period.parse("P4D");
    @Mock
    ...
    public void setup() {
        ...
        when(startdatoDiffInstance.get()).thenReturn(startdatoDiff);
    ...
    public void skal_håndtere_ugyldigInput_feil_fra_infotrygd() throws Exception {
        ...
        HentOgVurderInfotrygdSakTask task = new HentOgVurderInfotrygdSakTask(prosessTaskRepository, kodeverkRepository, gsakSakTjeneste, infotrygdTjeneste, aktørConsumer, infotrygdSakGyldigPeriodeInstance, infotrygdAnnenPartGyldigPeriodeInstance, startdatoDiffInstance);
    ...
    @Test
    public void skal_finne_relevant_infotrygdsak_for_inntektsmelding() throws Exception {
        ...
        InfotrygdSak infotrygdSak1 = new InfotrygdSak("id3", "FA", "FE", LocalDate.now().minusYears(2));
        InfotrygdSak infotrygdSak2 = new InfotrygdSak("id4", "FA", "FØ", LocalDate.now().minusDays(1));
    ...
    public void skal_finne_relevant_infotrygdsak_for_inntektsmelding_avsluttet_vedtak() throws Exception {
        ...
        InfotrygdSak infotrygdSak1 = new InfotrygdSak("id1", "FA", "FE", LocalDate.now().minusYears(2));
        InfotrygdSak infotrygdSak2 = new InfotrygdSak("id2", "FA", "FØ", LocalDate.now().minusDays(50));
        when(infotrygdTjeneste.finnSakListe(eq(FNR_BRUKER), any())).thenReturn(Arrays.asList(infotrygdSak1, infotrygdSak2));
    ...
    public void skal_sjekke_infotrygd_kun_for_bruker_ved_inntektsmelding() {
        GsakSak sak1 = new GsakSak(FNR_BRUKER, "id1", Tema.FORELDRE_OG_SVANGERSKAPSPENGER, Fagsystem.INFOTRYGD);

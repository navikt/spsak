...
public class InfotrygdTjenesteImplTest {
    ...
    private static final LocalDate DATE_20170823 = LocalDate.of(2017, 8, 23);
    private static final LocalDate DATE_20170401 = LocalDate.of(2017, 4, 1);
    private static final LocalDate DATE_20171017 = LocalDate.of(2017, 10, 17);
    private static final LocalDate DATE_20180101 = LocalDate.of(2018, 1, 1);
    ...
    private void mockSakListeForSøker() throws FinnSakListePersonIkkeFunnet, FinnSakListeSikkerhetsbegrensning, FinnSakListeUgyldigInput {
        FinnSakListeResponse response = new FinnSakListeResponse();
        response.getSakListe().add(opprettInfotrygdSak("FE"));
        when(infotrygdSakConsumer.finnSakListe(any())).thenReturn(response);
    }

    private void mockSakListeForEktefelle() throws FinnSakListePersonIkkeFunnet, FinnSakListeSikkerhetsbegrensning, FinnSakListeUgyldigInput {
        FinnSakListeResponse response = new FinnSakListeResponse();
        response.getSakListe().add(opprettInfotrygdSak("FE"));
    ...
    private no.nav.tjeneste.virksomhet.infotrygdsak.v1.informasjon.InfotrygdSak opprettInfotrygdSak(String relatertYtelseBehandlingstema) {

...
import no.nav.foreldrepenger.no.nav.spmottak.meldinger.dokumentnotifikasjonv1.Behandlingstema;
import no.nav.foreldrepenger.no.nav.spmottak.meldinger.dokumentnotifikasjonv1.Forsendelsesinformasjon;
import no.nav.foreldrepenger.no.nav.spmottak.meldinger.dokumentnotifikasjonv1.Tema;

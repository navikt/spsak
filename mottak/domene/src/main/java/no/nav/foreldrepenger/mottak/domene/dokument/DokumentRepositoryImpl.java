...
public class DokumentRepositoryImpl implements DokumentRepository {
    ...
    private DokumentRepositoryImpl() {
    ...
    @Override
    public void oppdaterForseldelseMedSaksnummer(UUID forsendelseId, String saksnummer) {
        oppdaterForsendelseMetadata(forsendelseId, null, saksnummer);
    }

...
public class DokumentforsendelseTjenesteImpl implements DokumentforsendelseTjeneste {
    ...
    private static final String METRIC_KEY_UPLOAD = "mottak.dokument.upload.";
    ...
    public void validerDokumentforsendelse(UUID forsendelseId) {
        ...
        Set<Dokument> hoveddokumenter = dokumenter.stream().filter(d -> d.erHovedDokument()).collect(toSet());

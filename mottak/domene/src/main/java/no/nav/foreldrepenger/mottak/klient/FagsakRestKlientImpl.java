...
public class FagsakRestKlientImpl implements FagsakRestKlient {
    ...
    public VurderFagsystemResultat vurderFagsystem(MottakMeldingDataWrapper dataWrapper) {
        ...
        boolean strukturertSøknad = dataWrapper.erStrukturertDokument().isPresent() && dataWrapper.erStrukturertDokument().get();
        ...
        if (dataWrapper.getDokumentKategori().isPresent()) {
            if (DokumentKategori.SØKNAD.equals(dataWrapper.getDokumentKategori().get())) {

...
public class DokumentforsendelseDto {
    ...
    private DokumentforsendelseDto() { //NOSONAR ... is marked "javax.validation.constraints.NotNull" but is not initialized in this constructor.
        //For Jackson
    }
...
class FilMetadataDto {
    ...
    private FilMetadataDto() { //NOSONAR ... is marked "javax.validation.constraints.NotNull" but is not initialized in this constructor.
        //For Jackson
    }

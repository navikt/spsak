...
insert into KONFIG_VERDI (id, konfig_kode, konfig_gruppe, konfig_verdi, gyldig_fom) values (nextval('SEQ_KONFIG_VERDI'), 'infotrygd.sak.gyldig.periode', 'INGEN', 'P10M', to_date('01.01.2016', 'dd.mm.yyyy'));
...
insert into KONFIG_VERDI (id, konfig_kode, konfig_gruppe, konfig_verdi, gyldig_fom) values (nextval('SEQ_KONFIG_VERDI'), 'gsak.ehentsid.fordelingsoppgaver', 'INGEN', '2820', to_date('01.01.2017', 'dd.mm.yyyy'));
...
insert into KONFIG_VERDI (id, konfig_kode, konfig_gruppe, konfig_verdi, gyldig_fom) values (nextval('SEQ_KONFIG_VERDI'), 'infotrygd.inntektsmelding.startdato.akseptert.diff', 'INGEN', 'P4D', to_date('01.01.2016', 'dd.mm.yyyy'));
...
insert into KONFIG_VERDI (id, konfig_kode, konfig_gruppe, konfig_verdi, gyldig_fom) values (nextval('SEQ_KONFIG_VERDI'), 'inntektsmelding.foreldrepenger.startdato', 'INGEN', '2019-01-01', to_date('12.12.2017', 'dd.mm.yyyy'));

...
(
  ...
  KL_KONFIG_VERDI_GRUPPE VARCHAR(100) /*GENERATED ALWAYS AS*/ DEFAULT ('KONFIG_VERDI_GRUPPE') /*VIRTUAL*/ NOT NULL,
  CONSTRAINT FK_KONFIG_VERDI_1 FOREIGN KEY (KONFIG_GRUPPE, KL_KONFIG_VERDI_GRUPPE) REFERENCES KODELISTE (KODE, KODEVERK)
);

CREATE SEQUENCE SEQ_KONFIG_VERDI MINVALUE 1000000 MAXVALUE 999999999999999999 INCREMENT BY 50 START WITH 1001200   no cycle;
...
(
  ...
  ENDRET_TID           TIMESTAMP(3),
  KL_KONFIG_VERDI_GRUPPE VARCHAR(100) /*GENERATED ALWAYS AS*/ DEFAULT ('KONFIG_VERDI_GRUPPE') /*VIRTUAL*/ NOT NULL,
  KL_KONFIG_VERDI_TYPE   VARCHAR(100) /*GENERATED ALWAYS AS*/ DEFAULT ('KONFIG_VERDI_TYPE') /*VIRTUAL*/   NOT NULL,

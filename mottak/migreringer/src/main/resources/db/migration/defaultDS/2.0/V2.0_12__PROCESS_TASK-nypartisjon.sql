...
alter table prosess_task add opprettet_av VARCHAR(30) default 'VL' not null;
alter table prosess_task add OPPRETTET_TID  TIMESTAMP(6) DEFAULT localtimestamp NOT NULL;
alter table prosess_task add BLOKKERT_AV bigint NULL;
